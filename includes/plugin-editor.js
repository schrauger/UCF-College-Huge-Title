        ...
        for (let mutation of mutations_list) {
            ...
            if (mutation.type === 'childList') {
                mutation.addedNodes.forEach(function(added_node) {
                    ...
                    while (currentNode) {
                        if (currentNode.id == 'acf-group_5c59f7549cc54') {
                ...
                console.log('attempt');
                jQuery('#acf-group_5c59f7549cc54').find('input').each(function() {jQuery(this).prop('readonly', true)});
                jQuery('#acf-group_5c59f7549cc54').find('[data-type="link"] .acf-js-tooltip').remove();
            } else {
